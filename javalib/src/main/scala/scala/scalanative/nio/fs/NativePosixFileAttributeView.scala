...
final class NativePosixFileAttributeView(path: Path, options: Array[LinkOption])
  ...
  override def setTimes(lastModifiedTime: FileTime,
    ...
    buf._1 =
      if (lastAccessTime != null) lastAccessTime.to(TimeUnit.SECONDS).asInstanceOf[CLong]
      else sb._7
    buf._2 =
      if (lastModifiedTime != null) lastModifiedTime.to(TimeUnit.SECONDS).asInstanceOf[CLong]
      else sb._8
